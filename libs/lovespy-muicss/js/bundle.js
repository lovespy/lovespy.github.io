...
(function (root, document) {
  ...
  manageDataSrcIframeAll(); */
		...
		observeMutations = function (scope, callback, settings) {
			...
			var getMutations = function (e) {
				var triggerOnMutation = function (m) {
					...
					if ("childList" === m.type || "subtree" === m.type || "attributes" === m.type || "characterData" === m.type) {
   ...
   to get milliseconds */
      ...
      observeMutations(cardGrid, throttleLogic, {log: false}); */
		...
		/* loadUnparsedJSON("./libs/lovespy-muicss/json/menus.json", function (jsonResponse) {
	...
	var scripts = [
	/* "./libs/lovespy-muicss/css/vendors.min.css", */
	"./libs/lovespy-muicss/css/bundle.min.css"];
  ...
  */
    ...
    */
	...
	"./libs/lovespy-muicss/css/vendors.min.css", onFontsLoadedCallback);
