...
gulp.task("browser-sync", ["bundle-assets"], function () {
	...
	gulp.watch("../../libs/lovespy-muicss/js/*.js").on("change", reload);
	gulp.watch("../../libs/lovespy-muicss/js/include-script/*.js").on("change", reload);
	gulp.watch("../../libs/lovespy-muicss/json/*.json").on("change", reload);
	gulp.watch("../../libs/lovespy-muicss/css/*.css").on("change", reload);
	gulp.watch("../../libs/lovespy-muicss/css/include-style/*.css").on("change", reload);
});
